...
from BBA_group.logic.rates_manager import calculate_spot_rate, update_weighted_locked_rate
...
def run(context, logger, assumptions: Assumptions = None, cohort_state=None):
    ...
    if assumptions:
        ...
        # 兼容旧代码：使用配置中的默认值
        from BBA_group.config import RATIO_IACF, RATIO_CLAIM, RATIO_MAINT_EXP, RATIO_RA
